...
<div class="mobile-menu md:hidden">
    ...
    <ul class="border-t border-theme-2 py-5 hidden">
        <li>
            <a href="{{ route('dashboard.index') }}" class="menu menu--active">
        ...
        <li>
            <a href="{{ route('wilayah.index') }}" class="menu">
        ...
        <li>
            <a href="{{ route('perkebunan.index') }}" class="menu">
                <div class="menu__icon"> <i data-feather="inbox"></i> </div>
                <div class="menu__title"> Perkebunan </div>
            </a>
        </li>
        <li>
            <a href="{{ route('hasil.index') }}" class="menu">
        ...
        <li>
            <a href="{{ route('tentang.user') }}" class="menu">
    ...
    <div class="h-full flex items-center">
        ...
        <div class="intro-x dropdown w-8 h-8">
            <div class="dropdown-toggle w-8 h-8 rounded-full overflow-hidden shadow-lg image-fit zoom-in scale-110"
                ...
                <img alt="Icewall Tailwind HTML Admin Template" src="{{ asset('dist')}}/images/profile-1.jpg">
            </div>
